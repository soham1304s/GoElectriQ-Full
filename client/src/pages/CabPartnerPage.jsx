          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 leading-[0.9]">
                Monetize Your <span className="text-emerald-400">EV Asset</span>.
              </h1>
              ...
              <button
                ...
                className="group px-12 py-6 bg-emerald-600 text-white rounded-3xl font-black text-xs uppercase tracking-[0.2em] hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-500/20 active:scale-[0.98] flex items-center gap-4"
              >
                Register Fleet Node
